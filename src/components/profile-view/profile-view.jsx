...
export class ProfileView extends React.Component {
  ...
  handleRemoveFavorite(e, movie) {
    ...
    axios
      .delete(`https://myflix-zag.herokuapp.com/users/${username}/FavoriteMovies/${movie}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(() => {
  ...
  render() {
    ...
    return (
      <Container className='profile-view'>
        <Tabs defaultActiveKey='profile' transition={false} className='profile-tabs' style={{ textDecoration: 'none' }}>
